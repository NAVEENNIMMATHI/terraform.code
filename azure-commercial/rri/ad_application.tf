resource "azuread_application" "ad_app_web" {
  ...
  reply_urls                 = ["http://localhost:4200/", "http://localhost:4200/signin-oidc","https://localhost:4201/signin-oidc","https://${lower(var.application_name)}${lower(var.app_gateway_environment_acronym)}.kpmgcloudops.com/signin-oidc","https://${lower(var.application_name)}${lower(var.app_gateway_environment_acronym)}.kpmgcloudops.com/"]
...
resource "azuread_application" "ad_app_rest" {
  ...
  homepage                   = "https://homepage"
  reply_urls                 = ["http://localhost:4201/", "http://localhost:4201/signin-oidc", "https://localhost:4201/signin-oidc", "https://${lower(var.application_name)}rest${lower(var.app_gateway_environment_acronym)}.kpmgcloudops.com/signin-oidc", "https://${lower(var.application_name)}rest${lower(var.app_gateway_environment_acronym)}.kpmgcloudops.com/"]
