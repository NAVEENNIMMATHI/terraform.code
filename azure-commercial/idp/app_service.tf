...
resource "azurerm_app_service" "app_service" {
  name                    = "idp${var.application_gateway.environment_acronym}"
  ...
  app_settings = {
    "APPINSIGHTS_INSTRUMENTATIONKEY"             = azurerm_application_insights.idp_webapp_insights.instrumentation_key
    "APPLICATIONINSIGHTS_CONNECTION_STRING"      = "InstrumentationKey=${azurerm_application_insights.idp_webapp_insights.instrumentation_key}"
