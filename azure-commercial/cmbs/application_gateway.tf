...
resource "azurerm_public_ip" "public_ip" {
  name                = "pip-appgateway-${lower(var.application_acronym)}-${lower(var.environment_acronym)}"
...
resource "azurerm_application_gateway" "cmbs_application_gateway" {
  ...
  backend_http_settings {
    ...
    host_name             = "fun-${var.location_acronym}-${var.application_acronym}-${var.environment_acronym}.kpmgcloudops.com"
  ...
  gateway_ip_configuration {
    ...
    subnet_id = data.terraform_remote_state.shared.outputs.app_gatewaysubnet_id
  }
