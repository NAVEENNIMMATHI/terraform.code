...
variable "tags_NodeMgmt" {
  type = map(string)
}
variable "tags_Networking" {
  type = map(string)
}
variable "tags_GatewayServices" {
  type = map(string)
}
variable "tags_SNOW" {
  type = map(string)
...
variable "tags_dr_Networking" {
  type = map(string)
}

variable "tags_firewall_policy_dr" {
  type = map(string)
}
...
variable "firewall_environment_dr" {
  type = string
}
...
variable "firewall_pip_environment_dr" {
  type = string
}
...
variable "firewall_policy_id_dr" {
  type = string
}

variable "firewall_policy_dr_name" {
    type = string
}  

variable "firewall_policy_dr_resource_group_name" {
    type = string
}

variable "firewall_policy_dr_location" {
    type = string
}

variable "dns_servers_dr" {
    type = list(string)
}

variable "ip_confi_name1" {
    type = string
    default = "firewall-ipconfig-primary"
}  

variable "ip_confi_name2" {
    type = string
    default = "firewall-ipconfig-klt-tomagakltp1"
}  

variable "ip_confi_name3" {
    type = string
    default = "firewall-ipconfig-klt-tomagakltuatp1"
}  

variable "ip_confi_name4" {
    type = string
    default = "firewall-ipconfig-KLT_tomagskltp1"
}  

variable "ip_confi_name5" {
    type = string
    default = "firewall-ipconfig-KLT_tomagskltuatp1"
} 

variable "ip_confi_dr_name1" {
    type = string
    default = ""
}  

variable "ip_confi_dr_name2" {
    type = string
    default = ""
}  

variable "ip_confi_dr_name3" {
    type = string
    default = ""
}  

variable "firewall_avail_zones" {
  type = list(string)
}
...
variable "dr_hubvnet_address_space" {
  type = list(string)
}
...
variable "subnet_address_space_web1_dr" {
  type = list(string)
}
variable "subnet_address_space_wu_cyberark_core" {
  type = list(string)
}
variable "subnet_address_space_wu_aadds" {
  type = list(string)
}
...
variable "core_binary_storage_account_name" {
  type    = string
  default = ""
}
...
variable "squid_proxy_load_balancer_private_static_ip" {
  type = string
}
...
variable "count_value_hybrid_worker_ha" {
  type = string
}
...
variable "netapp_user_name" {
  type = string
}
variable "netapp_user_password" {
  type = string
}
...
variable "rds1_vm_nic_private_ip_address" {
  type = string
}
