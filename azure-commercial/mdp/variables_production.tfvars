...
#Network Components
vnet_address_space = ["10.91.64.0/24", "10.91.65.0/24", "10.91.66.0/24", "10.91.68.0/22"]
...
databricks = {
  ...
  subnets = {
    private = {
      address_prefix = "10.91.64.64/26"
    }
    public = {
      address_prefix = "10.91.64.128/26"
    }
  }
}
...
privatelink_subnet_address_prefix = "10.91.66.0/24"
adf_subnet_address_prefix         = "10.91.64.16/28"
func_subnet_address_prefix        = "10.91.64.224/27"
...
build_subnet_address_prefix = "10.36.4.0/22"
...
iics_subnet_address_prefix = "10.91.64.0/28"

avscan_subnet_address_prefix = "10.91.64.16/28"
...
aks_cert_name                        = "mdp-pd.kpmgcloudops.com"
app_intg_cert_name                   = "mdp.kpmgcloudops.com"
api_pfx_cert_name                    = "mdpapi.kpmgcloudops.com"
api_developer_pfx_cert_name          = "mdpapi-developer.kpmgcloudops.com"
...
apim_subnet_address_prefix = "10.91.64.192/27"
virtual_network_type       = "Internal"
probe_path                 = "/status-0123456789abcdef"

spoke_vnet_name = "vnt-use-ase-pd"
spokevnetrgname = "RGP-USE-ASE-PD"
...
subnet_address_space_aks    = "10.91.68.0/22"

# Subnet address space for vnet integration
clamav_fap_subnet_address_prefix  = "10.91.65.64/27"
clamav_wap_subnet_address_prefix  = "10.91.65.32/27"
app_intg_subnet_address_prefix    = "10.91.65.192/26"
