resource "azurerm_template_deployment" "ase_ilb_shared" {
  name                = "ase_ilb_shared_deployment"
...
DEPLOY
  ...
  parameters = {
    "ase_Name"                     = "webuscdashared${upper(var.environment_acronym)}01"
    ...
    "dns_Suffix"                   = var.ase_ilb_dns_name
  }
