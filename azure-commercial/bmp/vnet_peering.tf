...
resource "azurerm_virtual_network_peering" "vnettocore" {
  name                         = var.environment == "production" ? "co-p-eastus-cobmp-vnet-to-CO-P-eastus-hub-vnet" : "${module.applicationvnet.virtual_network_name}-to-${var.corevnetname}"
...
resource "azurerm_virtual_network_peering" "vnettotransit" {
  name                         = var.environment == "production" ? "co-p-eastus-cobmp-vnet-to-CO-P-eastus-transit-vnet" : "${module.applicationvnet.virtual_network_name}-to-${var.transitvnetname}"
  virtual_network_name         = module.applicationvnet.virtual_network_name
  resource_group_name          = module.applicationrg.resource_group_name
...
resource "azurerm_virtual_network_peering" "coretovnet" {
  name                         = var.environment == "production" ? "CO-P-eastus-hub-vnet-to-co-p-eastus-cobmp-vnet" : "${var.corevnetname}-to-${module.applicationvnet.virtual_network_name}"
...
resource "azurerm_virtual_network_peering" "transittovnet" {
  name                         = var.environment == "production" ? "CO-P-eastus-transit-vnet-to-co-p-eastus-cobmp-vnet" : "${var.transitvnetname}-to-${module.applicationvnet.virtual_network_name}"
