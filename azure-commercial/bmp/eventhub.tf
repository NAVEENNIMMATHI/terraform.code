module "eventhubnamespace" {
  ...
  event_hub_namespace_name = var.environment == "production" ? "co-p-eastus-bmp1-eventhub" : "ehb-${var.location_acronym}-${var.application_acronym}-${var.environment_acronym}"
