resource "azurerm_web_application_firewall_policy" "arcgis_custom_waf_policy" {
  name                      = "waf-${var.location_acronym}-${var.application_acronym}-custom-${var.environment_acronym}"
