...
module "mssql_server_pra" {
    ...
    sqlTostorage_assignment_name_guiid  = "37c3aefe-b9f9-4a15-a0b8-76b4e26bdd8d"
...
resource "azurerm_sql_virtual_network_rule" "sqlvnetbuildvm" {
  ...
  resource_group_name = module.applicationrg.resource_group_name
  server_name         = module.mssql_server_pra.sql_server_name
...
resource "azurerm_mssql_elasticpool" "praelasticpool" {
