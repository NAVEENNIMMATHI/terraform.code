...
resource "azurerm_network_security_rule" "Inbound_Allow_443_From_Shared_DA_ASE_PIP" {
  name                        = "Inbound_Allow_443_From_Shared_DA_ASE_PIP"
  priority                    = 167
  direction                   = "Inbound"
  access                      = "Allow"
  protocol                    = "Tcp"
  source_port_range           = "*"
  destination_port_range      = "443"
  source_address_prefixes     = var.Shared_DA_ASE_PIP
  destination_address_prefix  = "*"
  resource_group_name         = module.applicationrg.resource_group_name
  network_security_group_name = module.agw1nsg.network_security_group_name
}
...
resource "azurerm_network_security_rule" "Outbound_Allow_443_Application_Gateway" {
  name                        = "Outbound_Allow_443_From_Application_Gateway"
  priority                    = 146
  direction                   = "Outbound"
  access                      = "Allow"
  protocol                    = "*"
  ...
  destination_port_range      = "443"
  source_address_prefix       = "*"
  destination_address_prefixes  = var.AGW_PIP
  resource_group_name         = module.applicationrg.resource_group_name
  network_security_group_name = module.ase1nsg.network_security_group_name
}
...
resource "azurerm_network_security_rule" "Inbound_Allow_443_Azure_Data_Explorer_Health_Monitor_adx1nsg" {
  ...
  source_port_range           = "*"
  destination_port_range      = "443"
  source_address_prefixes     = var.adx_healthmonitor_ip
  destination_address_prefix  = "VirtualNetwork"
  resource_group_name         = module.applicationrg.resource_group_name
  network_security_group_name = module.adx1nsg.network_security_group_name
}
...
resource "azurerm_network_security_rule" "kpimcapiq_allow_port_22" {
  ...
  destination_address_prefix  = "*"
  resource_group_name         = module.applicationrg.resource_group_name
  network_security_group_name = module.kpimcapiqnsg.network_security_group_name
}