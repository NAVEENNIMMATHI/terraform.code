module "eventhubnamespace" {
  ...
  event_hub_namespace_name = var.environment == "production" ? "co-pd-eastus-kip1-eventhub" : "ehb-${var.location_acronym}-${var.application_acronym}-${var.environment_acronym}"
