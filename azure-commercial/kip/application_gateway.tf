...
resource "azurerm_application_gateway" "appgw_production" {
  ...
  ssl_policy {
    ...
    cipher_suites              = var.environment == "production" ? ["TLS_RSA_WITH_AES_128_GCM_SHA256", "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384", "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA", "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384", "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384", "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA", "TLS_RSA_WITH_AES_256_GCM_SHA384", "TLS_RSA_WITH_AES_256_CBC_SHA256", "TLS_RSA_WITH_AES_256_CBC_SHA"] : ["TLS_RSA_WITH_AES_128_GCM_SHA256", "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384", "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA", "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384", "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384", "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA", "TLS_RSA_WITH_AES_256_GCM_SHA384", "TLS_RSA_WITH_AES_256_CBC_SHA256", "TLS_RSA_WITH_AES_256_CBC_SHA","TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256"]
  }
  ...
  frontend_ip_configuration {
    ...
    public_ip_address_id          = azurerm_public_ip.agwpip_production.id
  }
  ...
  http_listener {
    ...
    protocol                       = "Https"
    require_sni                    = "true"
    ssl_certificate_name           = var.environment == "production" ? var.kiprestcertname : var.kipcertname
  }
  ...
  http_listener {
    ...
    ssl_certificate_name           = var.environment == "production" ? var.mep-kipcertname : var.kipcertname
  }
  ...
  http_listener {
    ...
    ssl_certificate_name           = var.environment == "production" ? var.meprest-kipcertname : var.kipcertname
  }
  ...
  dynamic "ssl_certificate" {
    for_each = var.app_gateway_switch == null ? [] : tolist([var.app_gateway_switch])
    content {
