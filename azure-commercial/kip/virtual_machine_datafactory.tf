module "datafactory1vm" {
  ...
  count_value                  = var.count_value_adf1vm
  vm_size                      = var.vm_size_adf1vm
  ...
  data_disk_size               = var.data_disk_size_adf1vm
  ...
  admin_username = lower(
    "${var.application_acronym}ADF1${var.environment == "production" ? "PD1" : var.environment_acronym}ADMIN",
  )
